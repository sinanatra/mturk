(() => {
  ...
  var require_jquery = __commonJS((exports, module) => {
    ...
    (function(global, factory) {
      ...
      jQuery.fn = jQuery.prototype = {
        ...
        slice: function() {
          return this.pushStack(slice5.apply(this, arguments));
        },
        first: function() {
          return this.eq(0);
        },
      ...
      jQuery.extend = jQuery.fn.extend = function() {
        var options, name, src, copy3, copyIsArray, clone, target = arguments[0] || {}, i = 1, length3 = arguments.length, deep = false;
        ...
        for (; i < length3; i++) {
          if ((options = arguments[i]) != null) {
            for (name in options) {
              ...
              if (deep && copy3 && (jQuery.isPlainObject(copy3) || (copyIsArray = Array.isArray(copy3)))) {
                src = target[name];
                ...
                copyIsArray = false;
                target[name] = jQuery.extend(deep, clone, copy3);
      ...
      jQuery.extend({
        ...
        grep: function(elems, callback, invert) {
          var callbackInverse, matches = [], i = 0, length3 = elems.length, callbackExpect = !invert;
          for (; i < length3; i++) {
        ...
        map: function(elems, callback, arg) {
          var length3, value, i = 0, ret = [];
          if (isArrayLike(elems)) {
            length3 = elems.length;
            for (; i < length3; i++) {
      ...
      function isArrayLike(obj) {
        var length3 = !!obj && "length" in obj && obj.length, type2 = toType(obj);
        if (isFunction(obj) || isWindow(obj)) {
          return false;
        }
        return type2 === "array" || length3 === 0 || typeof length3 === "number" && length3 > 0 && length3 - 1 in obj;
      }
      var Sizzle = function(window3) {
        var i, support2, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate, setDocument, document3, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches, matches, contains, expando = "sizzle" + 1 * new Date(), preferredDoc = window3.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a4, b) {
          ...
          return 0;
        }, hasOwn2 = {}.hasOwnProperty, arr2 = [], pop = arr2.pop, pushNative = arr2.push, push2 = arr2.push, slice6 = arr2.slice, indexOf2 = function(list, elem) {
        ...
        try {
          push2.apply(arr2 = slice6.call(preferredDoc.childNodes), preferredDoc.childNodes);
          arr2[preferredDoc.childNodes.length].nodeType;
        } catch (e) {
          push2 = {
            apply: arr2.length ? function(target, els) {
              pushNative.apply(target, slice6.call(els));
            } : function(target, els) {
        ...
        function Sizzle2(selector, context, results, seed) {
          var m3, i2, elem, nid, match, groups2, newSelector, newContext = context && context.ownerDocument, nodeType = context ? context.nodeType : 9;
          results = results || [];
        ...
        function siblingCheck(a4, b) {
          var cur = b && a4, diff = cur && a4.nodeType === 1 && b.nodeType === 1 && a4.sourceIndex - b.sourceIndex;
          if (diff) {
            return diff;
          }
          if (cur) {
        ...
        setDocument = Sizzle2.setDocument = function(node) {
          ...
          contains = hasCompare || rnative.test(docElem.contains) ? function(a4, b) {
            var adown = a4.nodeType === 9 ? a4.documentElement : a4, bup = b && b.parentNode;
          ...
          sortOrder = hasCompare ? function(a4, b) {
            if (a4 === b) {
              hasDuplicate = true;
              return 0;
            }
            var compare = !a4.compareDocumentPosition - !b.compareDocumentPosition;
            if (compare) {
              return compare;
            }
            compare = (a4.ownerDocument || a4) == (b.ownerDocument || b) ? a4.compareDocumentPosition(b) : 1;
            if (compare & 1 || !support2.sortDetached && b.compareDocumentPosition(a4) === compare) {
              ...
              return sortInput ? indexOf2(sortInput, a4) - indexOf2(sortInput, b) : 0;
            }
            ...
            var cur, i2 = 0, aup = a4.parentNode, bup = b.parentNode, ap = [a4], bp = [b];
            if (!aup || !bup) {
              return a4 == document3 ? -1 : b == document3 ? 1 : aup ? -1 : bup ? 1 : sortInput ? indexOf2(sortInput, a4) - indexOf2(sortInput, b) : 0;
            } else if (aup === bup) {
              return siblingCheck(a4, b);
            }
            cur = a4;
        ...
        Expr = Sizzle2.selectors = {
          ...
          pseudos: {
            ...
            last: createPositionalPseudo(function(_matchIndexes, length3) {
              return [length3 - 1];
            }),
            eq: createPositionalPseudo(function(_matchIndexes, length3, argument) {
              return [argument < 0 ? argument + length3 : argument];
            }),
            even: createPositionalPseudo(function(matchIndexes, length3) {
              var i2 = 0;
              for (; i2 < length3; i2 += 2) {
            ...
            odd: createPositionalPseudo(function(matchIndexes, length3) {
              var i2 = 1;
              for (; i2 < length3; i2 += 2) {
                matchIndexes.push(i2);
              }
            ...
            lt: createPositionalPseudo(function(matchIndexes, length3, argument) {
              var i2 = argument < 0 ? argument + length3 : argument > length3 ? length3 : argument;
              for (; --i2 >= 0; ) {
                matchIndexes.push(i2);
              }
              return matchIndexes;
            }),
            gt: createPositionalPseudo(function(matchIndexes, length3, argument) {
              var i2 = argument < 0 ? argument + length3 : argument;
              for (; ++i2 < length3; ) {
                matchIndexes.push(i2);
              }
              return matchIndexes;
        ...
        tokenize = Sizzle2.tokenize = function(selector, parseOnly) {
          var matched, match, tokens, type2, soFar, groups2, preFilters, cached = tokenCache[selector + " "];
          if (cached) {
          ...
          return parseOnly ? soFar.length : soFar ? Sizzle2.error(selector) : tokenCache(selector, groups2).slice(0);
        };
        ...
        select = Sizzle2.select = function(selector, context, results, seed) {
          var i2, tokens, token, type2, find3, compiled = typeof selector === "function" && selector, match = !seed && tokenize(selector = compiled.selector || selector);
          results = results || [];
          if (match.length === 1) {
      ...
      var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init2 = jQuery.fn.init = function(selector, context, root3) {
        var match, elem;
        if (!selector) {
          return this;
        }
        root3 = root3 || rootjQuery;
        if (typeof selector === "string") {
          ...
          if (match && (match[1] || !context)) {
            ...
            return (context || root3).find(selector);
          } else {
          ...
          return root3.ready !== void 0 ? root3.ready(selector) : selector(jQuery);
        }
        ...
        var firing, memory, fired, locked, list = [], queue = [], firingIndex = -1, fire = function() {
          ...
          remove: function() {
            jQuery.each(arguments, function(_, arg) {
              var index3;
              while ((index3 = jQuery.inArray(arg, list, index3)) > -1) {
                list.splice(index3, 1);
                if (index3 <= firingIndex) {
                  firingIndex--;
                }
              }
            });
      ...
      jQuery.extend({
              ...
              function resolve(depth, deferred2, handler, special) {
                return function() {
                  var that = this, args = arguments, mightThrow = function() {
                    ...
                    if (isFunction(then)) {
                      if (special) {
                        then.call(returned, resolve(maxDepth2, deferred2, Identity, special), resolve(maxDepth2, deferred2, Thrower, special));
                      } else {
                        maxDepth2++;
                        then.call(returned, resolve(maxDepth2, deferred2, Identity, special), resolve(maxDepth2, deferred2, Thrower, special), resolve(maxDepth2, deferred2, Identity, deferred2.notifyWith));
                      }
                    } else {
                      if (handler !== Identity) {
                        that = void 0;
        ...
        when: function(singleValue) {
          var remaining = arguments.length, i = remaining, resolveContexts = Array(i), resolveValues = slice5.call(arguments), primary = jQuery.Deferred(), updateFunc = function(i2) {
            return function(value) {
              resolveContexts[i2] = this;
              resolveValues[i2] = arguments.length > 1 ? slice5.call(arguments) : value;
              if (!--remaining) {
      ...
      jQuery.fn.extend({
        ...
        promise: function(type2, obj) {
          var tmp, count3 = 1, defer = jQuery.Deferred(), elements = this, i = this.length, resolve = function() {
            if (!--count3) {
      ...
      function showHide(elements, show) {
        var display, elem, values = [], index3 = 0, length3 = elements.length;
        for (; index3 < length3; index3++) {
          elem = elements[index3];
          if (!elem.style) {
            continue;
          }
          ...
          if (show) {
            if (display === "none") {
              values[index3] = dataPriv.get(elem, "display") || null;
              if (!values[index3]) {
                elem.style.display = "";
              }
            }
            if (elem.style.display === "" && isHiddenWithinTree(elem)) {
              values[index3] = getDefaultDisplay(elem);
            }
          } else {
            if (display !== "none") {
              values[index3] = "none";
        ...
        for (index3 = 0; index3 < length3; index3++) {
          if (values[index3] != null) {
            elements[index3].style.display = values[index3];
          }
        }
        return elements;
      }
      ...
      function domManip(collection, args, callback, ignored) {
        ...
        if (valueIsFunction || l > 1 && typeof value === "string" && !support.checkClone && rchecked.test(value)) {
          return collection.each(function(index3) {
            ...
            if (valueIsFunction) {
              args[0] = value.call(this, index3, self2.html());
            }
      ...
      var swap3 = function(elem, options, callback) {
        var ret, name, old = {};
        for (name in options) {
      ...
      jQuery.each(["height", "width"], function(_i, dimension) {
        jQuery.cssHooks[dimension] = {
          get: function(elem, computed, extra) {
            if (computed) {
              return rdisplayswap.test(jQuery.css(elem, "display")) && (!elem.getClientRects().length || !elem.getBoundingClientRect().width) ? swap3(elem, cssShow, function() {
      ...
      function createTween(value, prop, animation) {
        var tween, collection = (Animation.tweeners[prop] || []).concat(Animation.tweeners["*"]), index3 = 0, length3 = collection.length;
        for (; index3 < length3; index3++) {
          if (tween = collection[index3].call(animation, prop, value)) {
            return tween;
          }
        }
      }
      ...
      function propFilter(props, specialEasing) {
        var index3, name, easing, value, hooks;
        for (index3 in props) {
          name = camelCase(index3);
          easing = specialEasing[name];
          value = props[index3];
          if (Array.isArray(value)) {
            easing = value[1];
            value = props[index3] = value[0];
          }
          if (index3 !== name) {
            props[name] = value;
            delete props[index3];
          ...
          if (hooks && "expand" in hooks) {
            ...
            for (index3 in value) {
              if (!(index3 in props)) {
                props[index3] = value[index3];
                specialEasing[index3] = easing;
              }
            }
          } else {
      ...
      function Animation(elem, properties, options) {
        var result, stopped, index3 = 0, length3 = Animation.prefilters.length, deferred = jQuery.Deferred().always(function() {
          delete tick.elem;
        }), tick = function() {
          if (stopped) {
            return false;
          }
          var currentTime = fxNow || createFxNow(), remaining = Math.max(0, animation.startTime + animation.duration - currentTime), temp = remaining / animation.duration || 0, percent = 1 - temp, index4 = 0, length4 = animation.tweens.length;
          for (; index4 < length4; index4++) {
            animation.tweens[index4].run(percent);
          }
          deferred.notifyWith(elem, [animation, percent, remaining]);
          if (percent < 1 && length4) {
            return remaining;
          }
          if (!length4) {
          ...
          stop: function(gotoEnd) {
            var index4 = 0, length4 = gotoEnd ? animation.tweens.length : 0;
            if (stopped) {
              return this;
            }
            stopped = true;
        ...
        for (; index3 < length3; index3++) {
          result = Animation.prefilters[index3].call(animation, elem, props, animation.opts);
          if (result) {
      ...
      jQuery.Animation = jQuery.extend(Animation, {
        ...
        tweener: function(props, callback) {
          ...
          var prop, index3 = 0, length3 = props.length;
          for (; index3 < length3; index3++) {
            prop = props[index3];
      ...
      jQuery.fn.extend({
        ...
        animate: function(prop, speed, easing, callback) {
          var empty4 = jQuery.isEmptyObject(prop), optall = jQuery.speed(speed, easing, callback), doAnimation = function() {
        ...
        stop: function(type2, clearQueue, gotoEnd) {
          ...
          return this.each(function() {
            var dequeue = true, index3 = type2 != null && type2 + "queueHooks", timers = jQuery.timers, data = dataPriv.get(this);
            if (index3) {
              if (data[index3] && data[index3].stop) {
                stopQueue(data[index3]);
              }
            } else {
              for (index3 in data) {
                if (data[index3] && data[index3].stop && rrun.test(index3)) {
                  stopQueue(data[index3]);
                }
              }
            }
            for (index3 = timers.length; index3--; ) {
              if (timers[index3].elem === this && (type2 == null || timers[index3].queue === type2)) {
                timers[index3].anim.stop(gotoEnd);
                dequeue = false;
        ...
        finish: function(type2) {
          ...
          return this.each(function() {
            var index3, data = dataPriv.get(this), queue = data[type2 + "queue"], hooks = data[type2 + "queueHooks"], timers = jQuery.timers, length3 = queue ? queue.length : 0;
            data.finish = true;
            ...
            for (index3 = timers.length; index3--; ) {
              if (timers[index3].elem === this && timers[index3].queue === type2) {
                timers[index3].anim.stop(true);
                timers.splice(index3, 1);
              }
            }
            for (index3 = 0; index3 < length3; index3++) {
              if (queue[index3] && queue[index3].finish) {
                queue[index3].finish.call(this);
              }
            }
            delete data.finish;
          });
      ...
      jQuery.extend({
        valHooks: {
          ...
          select: {
            get: function(elem) {
              var value, option, i, options = elem.options, index3 = elem.selectedIndex, one2 = elem.type === "select-one", values = one2 ? null : [], max5 = one2 ? index3 + 1 : options.length;
              if (index3 < 0) {
                i = max5;
              } else {
                i = one2 ? index3 : 0;
              ...
              for (; i < max5; i++) {
                option = options[i];
                if ((option.selected || i === index3) && !option.disabled && (!option.parentNode.disabled || !nodeName(option.parentNode, "optgroup"))) {
      ...
      function ajaxHandleResponses(s2, jqXHR, responses) {
        var ct, type2, finalDataType, firstDataType, contents = s2.contents, dataTypes = s2.dataTypes;
        while (dataTypes[0] === "*") {
          dataTypes.shift();
          if (ct === void 0) {
      ...
      jQuery.fn.load = function(url, params, callback) {
        ...
        if (self2.length > 0) {
          jQuery.ajax({
            ...
            response = arguments;
            self2.html(selector ? jQuery("<div>").append(jQuery.parseHTML(responseText2)).find(selector) : responseText2);
      ...
      jQuery.proxy = function(fn, context) {
        ...
        args = slice5.call(arguments, 2);
        proxy = function() {
          return fn.apply(context || this, args.concat(slice5.call(arguments)));
        };
  ...
  // node_modules/topojson/node_modules/topojson-client/dist/topojson-client.js
  var require_topojson_client = __commonJS((exports, module) => {
    (function(global, factory) {
      ...
      var bbox = function(topology) {
        var t = transform2(topology.transform), key, x06 = Infinity, y06 = x06, x12 = -x06, y12 = -x06;
      ...
      var reverse2 = function(array4, n) {
      ...
      function feature$1(topology, o) {
        var id2 = o.id, bbox2 = o.bbox, properties = o.properties == null ? {} : o.properties, geometry = object2(topology, o);
      ...
      function object2(topology, o) {
        var transformPoint = transform2(topology.transform), arcs = topology.arcs;
      ...
      function meshArcs(topology, object$$1, filter3) {
        var arcs, i, n;
        if (arguments.length > 1)
          arcs = extractArcs(topology, object$$1, filter3);
        else
          for (i = 0, arcs = new Array(n = topology.arcs.length); i < n; ++i)
            arcs[i] = i;
        return {type: "MultiLineString", arcs: stitch(topology, arcs)};
      }
      function extractArcs(topology, object$$1, filter3) {
      ...
      function planarRingArea(ring) {
        var i = -1, n = ring.length, a4, b = ring[n - 1], area = 0;
        while (++i < n)
          a4 = b, b = ring[i], area += a4[0] * b[1] - a4[1] * b[0];
        return Math.abs(area);
      }
      var merge2 = function(topology) {
      ...
      var untransform = function(transform3) {
        if (transform3 == null)
          return identity6;
        var x06, y06, kx2 = transform3.scale[0], ky2 = transform3.scale[1], dx = transform3.translate[0], dy = transform3.translate[1];
        return function(input, i) {
      ...
      var quantize2 = function(topology, transform3) {
        if (topology.transform)
        ...
        var t = untransform(transform3), box, key, inputs = topology.objects, outputs = {};
  ...
  var require_topojson_server = __commonJS((exports, module) => {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : factory(global.topojson = global.topojson || {});
    })(exports, function(exports2) {
      "use strict";
      var bounds = function(objects) {
        var x06 = Infinity, y06 = Infinity, x12 = -Infinity, y12 = -Infinity;
        function boundGeometry(geometry2) {
          if (geometry2 != null && boundGeometryType.hasOwnProperty(geometry2.type))
        ...
        function boundPoint(coordinates2) {
        ...
        function boundLine(coordinates2) {
          coordinates2.forEach(boundPoint);
        }
        function boundMultiLine(coordinates2) {
          coordinates2.forEach(boundLine);
        }
        for (var key in objects) {
          boundGeometry(objects[key]);
        }
        return x12 >= x06 && y12 >= y06 ? [x06, y06, x12, y12] : void 0;
      };
      var hashset = function(size, hash, equal, type2, empty4) {
        if (arguments.length === 3) {
          type2 = Array;
          empty4 = null;
        }
        var store = new type2(size = 1 << Math.max(4, Math.ceil(Math.log(size) / Math.LN2))), mask = size - 1;
        for (var i = 0; i < size; ++i) {
          store[i] = empty4;
        }
        function add2(value) {
          var index3 = hash(value) & mask, match = store[index3], collisions = 0;
          while (match != empty4) {
            if (equal(match, value))
              return true;
            if (++collisions >= size)
              throw new Error("full hashset");
            match = store[index3 = index3 + 1 & mask];
          }
          store[index3] = value;
          return true;
        }
      ...
      var hashmap = function(size, hash, equal, keyType, keyEmpty, valueType) {
        ...
        function set4(key, value) {
          var index3 = hash(key) & mask, matchKey = keystore[index3], collisions = 0;
          while (matchKey != keyEmpty) {
            if (equal(matchKey, key))
              return valstore[index3] = value;
            if (++collisions >= size)
              throw new Error("full hashmap");
            matchKey = keystore[index3 = index3 + 1 & mask];
          }
          keystore[index3] = key;
          valstore[index3] = value;
          return value;
        }
        ...
        function get3(key, missingValue) {
          var index3 = hash(key) & mask, matchKey = keystore[index3], collisions = 0;
          while (matchKey != keyEmpty) {
            if (equal(matchKey, key))
              return valstore[index3];
      ...
      var join = function(topology2) {
        var coordinates2 = topology2.coordinates, lines = topology2.lines, rings = topology2.rings, indexes2 = index3(), visitedByIndex = new Int32Array(coordinates2.length), leftByIndex = new Int32Array(coordinates2.length), rightByIndex = new Int32Array(coordinates2.length), junctionByIndex = new Int8Array(coordinates2.length), junctionCount = 0, i, n, previousIndex, currentIndex, nextIndex;
        for (i = 0, n = coordinates2.length; i < n; ++i) {
          visitedByIndex[i] = leftByIndex[i] = rightByIndex[i] = -1;
        }
        for (i = 0, n = lines.length; i < n; ++i) {
          var line = lines[i], lineStart = line[0], lineEnd = line[1];
          currentIndex = indexes2[lineStart];
          nextIndex = indexes2[++lineStart];
          ++junctionCount, junctionByIndex[currentIndex] = 1;
          while (++lineStart <= lineEnd) {
            sequence(i, previousIndex = currentIndex, currentIndex = nextIndex, nextIndex = indexes2[lineStart]);
          }
        ...
        for (i = 0, n = rings.length; i < n; ++i) {
          ...
          previousIndex = indexes2[ringEnd - 1];
          currentIndex = indexes2[ringStart - 1];
          nextIndex = indexes2[ringStart];
          sequence(i, previousIndex, currentIndex, nextIndex);
          while (++ringStart <= ringEnd) {
            sequence(i, previousIndex = currentIndex, currentIndex = nextIndex, nextIndex = indexes2[ringStart]);
          }
        }
        ...
        function index3() {
          var indexByPoint = hashmap(coordinates2.length * 1.4, hashIndex, equalIndex, Int32Array, -1, Int32Array), indexes3 = new Int32Array(coordinates2.length);
          for (var i2 = 0, n2 = coordinates2.length; i2 < n2; ++i2) {
            indexes3[i2] = indexByPoint.maybeSet(i2, i2);
          }
          return indexes3;
        }
        function hashIndex(i2) {
          return hashPoint(coordinates2[i2]);
        }
        function equalIndex(i2, j2) {
          return equalPoint(coordinates2[i2], coordinates2[j2]);
        }
        visitedByIndex = leftByIndex = rightByIndex = null;
        var junctionByPoint = hashset(junctionCount * 1.4, hashPoint, equalPoint), j;
        for (i = 0, n = coordinates2.length; i < n; ++i) {
          if (junctionByIndex[j = indexes2[i]]) {
            junctionByPoint.add(coordinates2[j]);
          }
        }
        return junctionByPoint;
      };
      var cut = function(topology2) {
        var junctions = join(topology2), coordinates2 = topology2.coordinates, lines = topology2.lines, rings = topology2.rings, next, i, n;
        for (i = 0, n = lines.length; i < n; ++i) {
          var line = lines[i], lineMid = line[0], lineEnd = line[1];
          while (++lineMid < lineEnd) {
            if (junctions.has(coordinates2[lineMid])) {
        ...
        for (i = 0, n = rings.length; i < n; ++i) {
          var ring = rings[i], ringStart = ring[0], ringMid = ringStart, ringEnd = ring[1], ringFixed = junctions.has(coordinates2[ringStart]);
          while (++ringMid < ringEnd) {
            if (junctions.has(coordinates2[ringMid])) {
              if (ringFixed) {
                next = {0: ringMid, 1: ring[1]};
                ring[1] = ringMid;
                ring = ring.next = next;
              } else {
                rotateArray(coordinates2, ringStart, ringEnd, ringEnd - ringMid);
                coordinates2[ringEnd] = coordinates2[ringStart];
                ringFixed = true;
                ringMid = ringStart;
              }
            }
      ...
      function rotateArray(array4, start2, end, offset) {
        reverse2(array4, start2, end);
        reverse2(array4, start2, start2 + offset);
        reverse2(array4, start2 + offset, end);
      }
      function reverse2(array4, start2, end) {
        for (var mid = start2 + (end-- - start2 >> 1), t; start2 < mid; ++start2, --end) {
          t = array4[start2], array4[start2] = array4[end], array4[end] = t;
        }
      }
      var dedup = function(topology2) {
        var coordinates2 = topology2.coordinates, lines = topology2.lines, line, rings = topology2.rings, ring, arcCount = lines.length + rings.length, i, n;
        ...
        function dedupLine(arc) {
          ...
          if (startArcs = arcsByEnd.get(startPoint = coordinates2[arc[0]])) {
          ...
          if (endArcs = arcsByEnd.get(endPoint = coordinates2[arc[1]])) {
        ...
        function dedupRing(arc) {
          ...
          if (endArcs = arcsByEnd.get(endPoint = coordinates2[arc[0]])) {
            for (i2 = 0, n2 = endArcs.length; i2 < n2; ++i2) {
              endArc = endArcs[i2];
          ...
          if (endArcs = arcsByEnd.get(endPoint = coordinates2[arc[0] + findMinimumOffset(arc)])) {
            for (i2 = 0, n2 = endArcs.length; i2 < n2; ++i2) {
              endArc = endArcs[i2];
              if (equalRing(endArc, arc)) {
                arc[0] = endArc[0];
        ...
        function equalLine(arcA, arcB) {
          ...
          if (ia - ja !== ib - jb)
            return false;
          for (; ia <= ja; ++ia, ++ib)
            if (!equalPoint(coordinates2[ia], coordinates2[ib]))
              return false;
          return true;
        }
        function reverseEqualLine(arcA, arcB) {
          ...
          if (ia - ja !== ib - jb)
            return false;
          for (; ia <= ja; ++ia, --jb)
            if (!equalPoint(coordinates2[ia], coordinates2[jb]))
              return false;
          return true;
        }
        function equalRing(arcA, arcB) {
          ...
          if (n2 !== jb - ib)
            return false;
          var ka2 = findMinimumOffset(arcA), kb = findMinimumOffset(arcB);
          for (var i2 = 0; i2 < n2; ++i2) {
            if (!equalPoint(coordinates2[ia + (i2 + ka2) % n2], coordinates2[ib + (i2 + kb) % n2]))
              return false;
          }
          return true;
        }
        function reverseEqualRing(arcA, arcB) {
          ...
          if (n2 !== jb - ib)
            return false;
          var ka2 = findMinimumOffset(arcA), kb = n2 - findMinimumOffset(arcB);
          for (var i2 = 0; i2 < n2; ++i2) {
            if (!equalPoint(coordinates2[ia + (i2 + ka2) % n2], coordinates2[jb - (i2 + kb) % n2]))
              return false;
          }
          return true;
        }
        function findMinimumOffset(arc) {
          var start2 = arc[0], end = arc[1], mid = start2, minimum = mid, minimumPoint = coordinates2[mid];
          while (++mid < end) {
            var point6 = coordinates2[mid];
      ...
      var delta = function(arcs) {
        ...
        while (++i < n) {
          var arc = arcs[i], j = 0, k2 = 1, m3 = arc.length, point6 = arc[0], x06 = point6[0], y06 = point6[1], x12, y12;
          while (++j < m3) {
            point6 = arc[j], x12 = point6[0], y12 = point6[1];
            if (x12 !== x06 || y12 !== y06)
              arc[k2++] = [x12 - x06, y12 - y06], x06 = x12, y06 = y12;
          }
          if (k2 === 1)
            arc[k2++] = [0, 0];
          arc.length = k2;
      ...
      var extract = function(objects) {
        var index3 = -1, lines = [], rings = [], coordinates2 = [];
        function extractGeometry(geometry2) {
          if (geometry2 && extractGeometryType.hasOwnProperty(geometry2.type))
        ...
        function extractLine(line) {
          for (var i = 0, n = line.length; i < n; ++i)
            coordinates2[++index3] = line[i];
          var arc = {0: index3 - n + 1, 1: index3};
          lines.push(arc);
          return arc;
        }
        function extractRing(ring) {
          for (var i = 0, n = ring.length; i < n; ++i)
            coordinates2[++index3] = ring[i];
          var arc = {0: index3 - n + 1, 1: index3};
          rings.push(arc);
          return arc;
        }
      ...
      var prequantize = function(objects, bbox, n) {
        var x06 = bbox[0], y06 = bbox[1], x12 = bbox[2], y12 = bbox[3], kx2 = x12 - x06 ? (n - 1) / (x12 - x06) : 1, ky2 = y12 - y06 ? (n - 1) / (y12 - y06) : 1;
        function quantizePoint(input) {
          return [Math.round((input[0] - x06) * kx2), Math.round((input[1] - y06) * ky2)];
        }
        function quantizePoints(input, m3) {
          var i = -1, j = 0, n2 = input.length, output = new Array(n2), pi7, px, py, x4, y4;
          while (++i < n2) {
            pi7 = input[i];
            x4 = Math.round((pi7[0] - x06) * kx2);
            y4 = Math.round((pi7[1] - y06) * ky2);
            if (x4 !== px || y4 !== py)
              output[j++] = [px = x4, py = y4];
          }
          output.length = j;
          while (j < m3)
      ...
      var topology = function(objects, quantization) {
        var bbox = bounds(objects = geometry(objects)), transform2 = quantization > 0 && bbox && prequantize(objects, bbox, quantization), topology2 = dedup(cut(extract(objects))), coordinates2 = topology2.coordinates, indexByArc = hashmap(topology2.arcs.length * 1.4, hashArc, equalArc);
        objects = topology2.objects;
        topology2.bbox = bbox;
        topology2.arcs = topology2.arcs.map(function(arc, i) {
          indexByArc.set(arc, i);
          return coordinates2.slice(arc[0], arc[1] + 1);
        });
        ...
        function indexArcs(arc) {
          var indexes2 = [];
          do {
            var index3 = indexByArc.get(arc);
            indexes2.push(arc[0] < arc[1] ? index3 : ~index3);
          } while (arc = arc.next);
          return indexes2;
        }
  ...
  var require_topojson_client2 = __commonJS((exports, module) => {
    (function(global, factory) {
      ...
      function transform2(transform3) {
        if (transform3 == null)
          return identity6;
        var x06, y06, kx2 = transform3.scale[0], ky2 = transform3.scale[1], dx = transform3.translate[0], dy = transform3.translate[1];
        return function(input, i) {
      ...
      function untransform(transform3) {
        if (transform3 == null)
          return identity6;
        var x06, y06, kx2 = transform3.scale[0], ky2 = transform3.scale[1], dx = transform3.translate[0], dy = transform3.translate[1];
        return function(input, i) {
      ...
      function quantize2(topology, transform3) {
        if (topology.transform)
          throw new Error("already quantized");
        if (!transform3 || !transform3.scale) {
          if (!((n = Math.floor(transform3)) >= 2))
  ...
  var require_topojson_simplify = __commonJS((exports, module) => {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require_topojson_client2()) : typeof define === "function" && define.amd ? define(["exports", "topojson-client"], factory) : factory(global.topojson = global.topojson || {}, global.topojson);
    })(exports, function(exports2, topojsonClient) {
      "use strict";
      var prune = function(topology) {
        ...
        function scanArc(index3) {
          if (index3 < 0)
            index3 = ~index3;
          if (!newIndexByOldIndex[index3])
            newIndexByOldIndex[index3] = 1, ++newArcsLength;
        }
      ...
      var filter3 = function(topology, filter4) {
        ...
        function filterExteriorRing(ring) {
          return filter4(ring, false);
        }
        function filterInteriorRing(ring) {
          return filter4(ring, true);
        }
        for (key in oldObjects) {
      ...
      var filterAttached = function(topology) {
        ...
        function testArcs(arcs) {
          for (var i = 0, n = arcs.length; i < n; ++i, ++ownerIndex) {
            for (var ring = arcs[i], j = 0, m3 = ring.length; j < m3; ++j) {
              var arc = ring[j];
              if (arc < 0)
                arc = ~arc;
        ...
        return function(ring) {
          for (var j = 0, m3 = ring.length, arc; j < m3; ++j) {
      ...
      function planarTriangleArea(triangle) {
        var a4 = triangle[0], b = triangle[1], c6 = triangle[2];
        return Math.abs((a4[0] - c6[0]) * (b[1] - a4[1]) - (a4[0] - b[0]) * (c6[1] - a4[1])) / 2;
      }
      function planarRingArea(ring) {
        var i = -1, n = ring.length, a4, b = ring[n - 1], area = 0;
        while (++i < n)
      ...
      var filterAttachedWeight = function(topology, minWeight, weight) {
        var a4 = filterAttached(topology), w = filterWeight(topology, minWeight, weight);
        return function(ring, interior) {
          return a4(ring, interior) || w(ring, interior);
        };
      };
      ...
      var newHeap = function() {
        var heap = {}, array4 = [], size = 0;
        heap.push = function(object2) {
          up(array4[object2._ = size] = object2, size++);
          return size;
        };
        heap.pop = function() {
          if (size <= 0)
            return;
          var removed = array4[0], object2;
          if (--size > 0)
            object2 = array4[size], down(array4[object2._ = 0] = object2, 0);
          return removed;
        };
        heap.remove = function(removed) {
          ...
          if (array4[i] !== removed)
            return;
          if (i !== --size)
            object2 = array4[size], (compare(object2, removed) < 0 ? up : down)(array4[object2._ = i] = object2, i);
          return i;
        };
        function up(object2, i) {
          while (i > 0) {
            var j = (i + 1 >> 1) - 1, parent = array4[j];
            if (compare(object2, parent) >= 0)
              break;
            array4[parent._ = i] = parent;
            array4[object2._ = i = j] = object2;
          }
        }
        function down(object2, i) {
          while (true) {
            var r = i + 1 << 1, l = r - 1, j = i, child = array4[j];
            if (l < size && compare(array4[l], child) < 0)
              child = array4[j = l];
            if (r < size && compare(array4[r], child) < 0)
              child = array4[j = r];
            if (j === i)
              break;
            array4[child._ = i] = child;
            array4[object2._ = i = j] = object2;
          }
        }
        return heap;
      };
      function copy3(point6) {
        return [point6[0], point6[1], 0];
      }
      var presimplify = function(topology, weight) {
        var point6 = topology.transform ? topojsonClient.transform(topology.transform) : copy3, heap = newHeap();
        if (weight == null)
      ...
      var quantile3 = function(topology, p) {
        var array4 = [];
        topology.arcs.forEach(function(arc) {
          arc.forEach(function(point6) {
            if (isFinite(point6[2])) {
              array4.push(point6[2]);
            }
          });
        });
        return array4.length && quantile$1(array4.sort(descending2), p);
      };
      function quantile$1(array4, p) {
        if (!(n = array4.length))
          return;
        if ((p = +p) <= 0 || n < 2)
          return array4[0];
        if (p >= 1)
          return array4[n - 1];
        var n, h = (n - 1) * p, i = Math.floor(h), a4 = array4[i], b = array4[i + 1];
        return a4 + (b - a4) * (h - i);
      }
      ...
      var simplify = function(topology, minWeight) {
        ...
        var arcs = topology.arcs.map(function(input) {
          var i = -1, j = 0, n = input.length, output = new Array(n), point6;
          while (++i < n) {
            if ((point6 = input[i])[2] >= minWeight) {
              output[j++] = [point6[0], point6[1]];
            }
          }
          output.length = j;
          return output;
      ...
      var pi7 = Math.PI;
      var tau8 = 2 * pi7;
      var quarterPi3 = pi7 / 4;
      var radians4 = pi7 / 180;
      var abs6 = Math.abs;
      var atan24 = Math.atan2;
      var cos5 = Math.cos;
      var sin5 = Math.sin;
      function halfArea(ring, closed) {
        var i = 0, n = ring.length, sum4 = 0, point6 = ring[closed ? i++ : n - 1], lambda04, lambda12 = point6[0] * radians4, phi12 = point6[1] * radians4 / 2 + quarterPi3, cosPhi03, cosPhi1 = cos5(phi12), sinPhi03, sinPhi1 = sin5(phi12);
        for (; i < n; ++i) {
          point6 = ring[i];
          lambda04 = lambda12, lambda12 = point6[0] * radians4;
          phi12 = point6[1] * radians4 / 2 + quarterPi3;
          cosPhi03 = cosPhi1, cosPhi1 = cos5(phi12);
          sinPhi03 = sinPhi1, sinPhi1 = sin5(phi12);
          var dLambda = lambda12 - lambda04, sdLambda = dLambda >= 0 ? 1 : -1, adLambda = sdLambda * dLambda, k2 = sinPhi03 * sinPhi1, u4 = cosPhi03 * cosPhi1 + k2 * cos5(adLambda), v2 = k2 * sdLambda * sin5(adLambda);
          sum4 += atan24(v2, u4);
        }
        return sum4;
      }
      function sphericalRingArea(ring, interior) {
        var sum4 = halfArea(ring, true);
        if (interior)
          sum4 *= -1;
        return (sum4 < 0 ? tau8 + sum4 : sum4) * 2;
      }
      function sphericalTriangleArea(t) {
        return abs6(halfArea(t, false)) * 2;
      }
      exports2.filter = filter3;
      exports2.filterAttached = filterAttached;
      exports2.filterAttachedWeight = filterAttachedWeight;
      exports2.filterWeight = filterWeight;
      exports2.planarRingArea = planarRingArea;
      exports2.planarTriangleArea = planarTriangleArea;
      exports2.presimplify = presimplify;
      exports2.quantile = quantile3;
      exports2.simplify = simplify;
      exports2.sphericalRingArea = sphericalRingArea;
      exports2.sphericalTriangleArea = sphericalTriangleArea;
      Object.defineProperty(exports2, "__esModule", {value: true});
    });
  });

  // node_modules/topojson/dist/topojson.node.js
  var require_topojson_node = __commonJS((exports) => {
    "use strict";
    Object.defineProperty(exports, "__esModule", {value: true});
    var topojsonClient = require_topojson_client();
    var topojsonServer = require_topojson_server();
    var topojsonSimplify = require_topojson_simplify();
  ...
  function rotationIdentity(lambda, phi2) {
    return [abs(lambda) > pi ? lambda + Math.round(-lambda / tau) * tau : lambda, phi2];
  }
  ...
  function circleRadius(cosRadius, point6) {
    ...
    return ((-point6[2] < 0 ? -radius : radius) + tau - epsilon) % tau;
  }
  function circle_default() {
    var center2 = constant_default([0, 0]), radius = constant_default(90), precision = constant_default(6), ring, rotate, stream = {point: point6};
    ...
    circle2.center = function(_) {
      return arguments.length ? (center2 = typeof _ === "function" ? _ : constant_default([+_[0], +_[1]]), circle2) : center2;
    };
  ...
  function pointEqual_default(a4, b) {
    return abs(a4[0] - b[0]) < epsilon && abs(a4[1] - b[1]) < epsilon;
  }
  ...
  function polygonContains_default(polygon, point6) {
    ...
    for (var i = 0, n = polygon.length; i < n; ++i) {
      ...
      for (var j = 0; j < m3; ++j, lambda04 = lambda12, sinPhi03 = sinPhi1, cosPhi03 = cosPhi1, point0 = point1) {
        var point1 = ring[j], lambda12 = longitude(point1), phi12 = point1[1] / 2 + quarterPi, sinPhi1 = sin(phi12), cosPhi1 = cos(phi12), delta = lambda12 - lambda04, sign4 = delta >= 0 ? 1 : -1, absDelta = sign4 * delta, antimeridian = absDelta > pi, k2 = sinPhi03 * sinPhi1;
        sum4.add(atan2(k2 * sign4 * sin(absDelta), cosPhi03 * cosPhi1 + k2 * cos(absDelta)));
    ...
    return (angle2 < -epsilon || angle2 < epsilon && sum4 < -epsilon2) ^ winding & 1;
  }
  ...
  function compareIntersection(a4, b) {
    return ((a4 = a4.x)[0] < 0 ? a4[1] - halfPi - epsilon : halfPi - a4[1]) - ((b = b.x)[0] < 0 ? b[1] - halfPi - epsilon : halfPi - b[1]);
  }
    ...
    function clipLine(stream) {
      ...
      return {
        ...
        point: function(lambda, phi2) {
          var point1 = [lambda, phi2], point22, v2 = visible(lambda, phi2), c6 = smallRadius ? v2 ? 0 : code(lambda, phi2) : v2 ? code(lambda + (lambda < 0 ? pi : -pi), phi2) : 0;
          if (!point0 && (v00 = v0 = v2))
            stream.lineStart();
          if (v2 !== v0) {
  ...
  function graticuleX(y06, y12, dy) {
    var y4 = range(y06, y12 - epsilon, dy).concat(y12);
    return function(x4) {
  ...
  function graticuleY(x06, x12, dx) {
    var x4 = range(x06, x12 - epsilon, dx).concat(x12);
    return function(y4) {
  ...
  function interpolate_default(a4, b) {
    var x06 = a4[0] * radians, y06 = a4[1] * radians, x12 = b[0] * radians, y12 = b[1] * radians, cy0 = cos(y06), sy0 = sin(y06), cy1 = cos(y12), sy1 = sin(y12), kx0 = cy0 * cos(x06), ky0 = cy0 * sin(x06), kx1 = cy1 * cos(x12), ky1 = cy1 * sin(x12), d = 2 * asin(sqrt(haversin(y12 - y06) + cy0 * cy1 * haversin(x12 - x06))), k2 = sin(d);
  ...
  function path_default(projection3, context) {
    ...
    path2.projection = function(_) {
      return arguments.length ? (projectionStream = _ == null ? (projection3 = null, identity_default) : (projection3 = _).stream, path2) : projection3;
    };
    ...
    return path2.projection(projection3).context(context);
  }
  ...
  function resample(project, delta2) {
    function resampleLineTo(x06, y06, lambda04, a0, b02, c0, x12, y12, lambda12, a1, b12, c1, depth, stream) {
      ...
      if (d2 > 4 * delta2 && depth--) {
        var a4 = a0 + a1, b = b02 + b12, c6 = c0 + c1, m3 = sqrt(a4 * a4 + b * b + c6 * c6), phi2 = asin(c6 /= m3), lambda22 = abs(abs(c6) - 1) < epsilon || abs(lambda04 - lambda12) < epsilon ? (lambda04 + lambda12) / 2 : atan2(b, a4), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
  ...
  function albersUsa_default() {
    ...
    albersUsa.translate = function(_) {
      ...
      alaskaPoint = alaska.translate([x4 - 0.307 * k2, y4 + 0.201 * k2]).clipExtent([[x4 - 0.425 * k2 + epsilon, y4 + 0.12 * k2 + epsilon], [x4 - 0.214 * k2 - epsilon, y4 + 0.234 * k2 - epsilon]]).stream(pointStream);
      hawaiiPoint = hawaii.translate([x4 - 0.205 * k2, y4 + 0.212 * k2]).clipExtent([[x4 - 0.214 * k2 + epsilon, y4 + 0.166 * k2 + epsilon], [x4 - 0.115 * k2 - epsilon, y4 + 0.234 * k2 - epsilon]]).stream(pointStream);
      return reset();
    };
  ...
  function mercatorProjection(project) {
    ...
    function reclip() {
      var k2 = pi * scale2(), t = m3(rotation_default(m3.rotate()).invert([0, 0]));
  ...
  function square_default(project) {
    ...
    function projectSquare(lambda, phi2) {
      var s2 = lambda > 0 ? -0.5 : 0.5, point6 = project(lambda + s2 * pi2, phi2);
      point6[0] -= s2 * dx;
      return point6;
    }
    if (project.invert)
      projectSquare.invert = function(x4, y4) {
        var s2 = x4 > 0 ? -0.5 : 0.5, location = project.invert(x4 + s2 * dx, y4), lambda = location[0] - s2 * pi2;
        if (lambda < -pi2)
          lambda += 2 * pi2;
        else if (lambda > pi2)
          lambda -= 2 * pi2;
  ...
  function ellipticJi(u4, v2, m3) {
    ...
    b = ellipticJ(v2, 1 - m3);
    c6 = b[1] * b[1] + m3 * a4[0] * a4[0] * b[0] * b[0];
    return [
      [a4[0] * b[2] / c6, a4[1] * a4[2] * b[0] * b[1] / c6],
      [a4[1] * b[1] / c6, -a4[0] * a4[2] * b[0] * b[2] / c6],
      [a4[2] * b[1] * b[2] / c6, -m3 * a4[0] * a4[1] * b[0] / c6]
    ];
  }
  function ellipticJ(u4, m3) {
    ...
    if (m3 >= 1 - epsilon3) {
      ...
      return [
        ...
        phi2 + ai * t * phi2 * (twon + u4),
        2 * atan3(exp2(u4)) - halfPi2 + ai * (twon - u4) / b
      ];
    }
    var a4 = [1, 0, 0, 0, 0, 0, 0, 0, 0], c6 = [sqrt3(m3), 0, 0, 0, 0, 0, 0, 0, 0], i = 0;
    b = sqrt3(1 - m3);
    twon = 1;
    while (abs2(c6[i] / a4[i]) > epsilon3 && i < 8) {
      ai = a4[i++];
      c6[i] = (ai - b) / 2;
      a4[i] = (ai + b) / 2;
      b = sqrt3(ai * b);
    ...
    phi2 = twon * a4[i] * u4;
    do {
      t = c6[i] * sin2(b = phi2) / a4[i];
      phi2 = (asin2(t) + phi2) / 2;
    } while (--i);
    return [sin2(phi2), t = cos2(phi2), t / cos2(phi2 - b), phi2];
  }
  function ellipticFi(phi2, psi, m3) {
    var r = abs2(phi2), i = abs2(psi), sinhPsi = sinh(i);
    if (r) {
      var cscPhi = 1 / sin2(r), cotPhi2 = 1 / (tan2(r) * tan2(r)), b = -(cotPhi2 + m3 * (sinhPsi * sinhPsi * cscPhi * cscPhi) - 1 + m3), c6 = (m3 - 1) * cotPhi2, cotLambda2 = (-b + sqrt3(b * b - 4 * c6)) / 2;
      return [
        ellipticF(atan3(1 / sqrt3(cotLambda2)), m3) * sign2(phi2),
        ellipticF(atan3(sqrt3((cotLambda2 / cotPhi2 - 1) / m3)), 1 - m3) * sign2(psi)
      ];
    }
    return [
      0,
      ellipticF(atan3(sinhPsi), 1 - m3) * sign2(psi)
    ];
  }
  function ellipticF(phi2, m3) {
    if (!m3)
      return phi2;
    if (m3 === 1)
      return log2(tan2(phi2 / 2 + quarterPi2));
    var a4 = 1, b = sqrt3(1 - m3), c6 = sqrt3(m3);
    for (var i = 0; abs2(c6) > epsilon3; i++) {
      if (phi2 % pi2) {
        var dPhi = atan3(b * tan2(phi2) / a4);
        if (dPhi < 0)
          dPhi += pi2;
        phi2 += dPhi + ~~(phi2 / pi2) * pi2;
      } else
        phi2 += phi2;
      c6 = (a4 + b) / 2;
      b = sqrt3(a4 * b);
    ...
    return phi2 / (pow2(2, i) * a4);
  }

  // node_modules/d3-geo-projection/src/guyou.js
  function guyouRaw(lambda, phi2) {
    var k_ = (sqrt2 - 1) / (sqrt2 + 1), k2 = sqrt3(1 - k_ * k_), K2 = ellipticF(halfPi2, k2 * k2), f = -1, psi = log2(tan2(pi2 / 4 + abs2(phi2) / 2)), r = exp2(f * psi) / sqrt3(k_), at = guyouComplexAtan(r * cos2(f * lambda), r * sin2(f * lambda)), t = ellipticFi(at[0], at[1], k2 * k2);
    return [-t[1], (phi2 >= 0 ? 1 : -1) * (0.5 * K2 - t[0])];
  }
  function guyouComplexAtan(x4, y4) {
    var x22 = x4 * x4, y_1 = y4 + 1, t = 1 - x22 - y4 * y4;
    return [
      0.5 * ((x4 >= 0 ? halfPi2 : -halfPi2) - atan22(t, 2 * x4)),
      -0.25 * log2(t * t + 4 * x22) + 0.5 * log2(y_1 * y_1 + x22)
    ];
  }
  ...
  guyouRaw.invert = function(x4, y4) {
    var k_ = (sqrt2 - 1) / (sqrt2 + 1), k2 = sqrt3(1 - k_ * k_), K2 = ellipticF(halfPi2, k2 * k2), f = -1, j = ellipticJi(0.5 * K2 - y4, -x4, k2 * k2), tn = guyouComplexDivide(j[0], j[1]), lambda = atan22(tn[1], tn[0]) / f;
    return [
      lambda,
  ...
  function axis(orient, scale2) {
    ...
    function axis2(context) {
      var values = tickValues == null ? scale2.ticks ? scale2.ticks.apply(scale2, tickArguments) : scale2.domain() : tickValues, format2 = tickFormat2 == null ? scale2.tickFormat ? scale2.tickFormat.apply(scale2, tickArguments) : identity_default3 : tickFormat2, spacing = Math.max(tickSizeInner, 0) + tickPadding, range4 = scale2.range(), range0 = +range4[0] + offset, range1 = +range4[range4.length - 1] + offset, position = (scale2.bandwidth ? center : number2)(scale2.copy(), offset), selection2 = context.selection ? context.selection() : context, path2 = selection2.selectAll(".domain").data([null]), tick = selection2.selectAll(".tick").data(values, scale2).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line = tick.select("line"), text = tick.select("text");
  ...
  function cubehelixConvert(o) {
    ...
    if (!(o instanceof Rgb))
      o = rgbConvert(o);
    var r = o.r / 255, g = o.g / 255, b = o.b / 255, l = (BC_DA * b + ED * r - EB * g) / (BC_DA + ED - EB), bl = b - l, k2 = (E * (g - l) - C * bl) / D, s2 = Math.sqrt(k2 * k2 + bl * bl) / (E * l * (1 - l)), h = s2 ? Math.atan2(k2, bl) * degrees3 - 120 : NaN;
  ...
  define_default(Cubehelix, cubehelix, extend(Color, {
    ...
    rgb() {
      var h = isNaN(this.h) ? 0 : (this.h + 120) * radians3, l = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l * (1 - l), cosh3 = Math.cos(h), sinh3 = Math.sin(h);
      return new Rgb(255 * (l + a4 * (A * cosh3 + B * sinh3)), 255 * (l + a4 * (C * cosh3 + D * sinh3)), 255 * (l + a4 * (E * cosh3)), this.opacity);
    }
  }));
  ...
  function hue(a4, b) {
    var d = b - a4;
    return d ? linear(a4, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant_default4(isNaN(a4) ? b : a4);
  }
  function gamma(y4) {
    return (y4 = +y4) === 1 ? nogamma : function(a4, b) {
      return b - a4 ? exponential(a4, b, y4) : constant_default4(isNaN(a4) ? b : a4);
    };
  }
  function nogamma(a4, b) {
    var d = b - a4;
    return d ? linear(a4, d) : constant_default4(isNaN(a4) ? b : a4);
  }
  ...
  var {abs: abs3, max: max2, min: min2} = Math;
  function number1(e) {
    return [+e[0], +e[1]];
  }
  function number22(e) {
    ...
    function started(event) {
      ...
      function moved(event2) {
        ...
        if (shifting && !lockX && !lockY && points.length === 1) {
          ...
          if (abs3(point6.cur[0] - point6[0]) > abs3(point6.cur[1] - point6[1]))
            lockY = true;
          else
            lockX = true;
        }
  ...
  function chord(directed, transpose2) {
    ...
    function chord2(matrix) {
      var n = matrix.length, groupSums = new Array(n), groupIndex = range3(0, n), chords = new Array(n * n), groups2 = new Array(n), k2 = 0, dx;
      ...
      dx = k2 ? padAngle : tau4 / n;
      {
        ...
        for (const i of groupIndex) {
          const x06 = x4;
          if (directed) {
            const subgroupIndex = range3(~n + 1, n).filter((j) => j < 0 ? matrix[~j * n + i] : matrix[i * n + j]);
            if (sortSubgroups)
            ...
            const subgroupIndex = range3(0, n).filter((j) => matrix[i * n + j] || matrix[j * n + i]);
            if (sortSubgroups)
  ...
  function ribbon(headRadius) {
    ...
    function ribbon2() {
      var buffer, s2 = source.apply(this, arguments), t = target.apply(this, arguments), ap = padAngle.apply(this, arguments) / 2, argv = slice2.call(arguments), sr = +sourceRadius.apply(this, (argv[0] = s2, argv)), sa0 = startAngle.apply(this, argv) - halfPi4, sa1 = endAngle.apply(this, argv) - halfPi4, tr = +targetRadius.apply(this, (argv[0] = t, argv)), ta0 = startAngle.apply(this, argv) - halfPi4, ta1 = endAngle.apply(this, argv) - halfPi4;
      if (!context)
        context = buffer = path_default2();
      if (ap > epsilon5) {
        if (abs4(sa1 - sa0) > ap * 2 + epsilon5)
          sa1 > sa0 ? (sa0 += ap, sa1 -= ap) : (sa0 -= ap, sa1 += ap);
        else
          sa0 = sa1 = (sa0 + sa1) / 2;
        if (abs4(ta1 - ta0) > ap * 2 + epsilon5)
  ...
  function buffer_default2(input, init2) {
  ...
  function locale_default(locale3) {
    var group2 = locale3.grouping === void 0 || locale3.thousands === void 0 ? identity_default4 : formatGroup_default(map3.call(locale3.grouping, Number), locale3.thousands + ""), currencyPrefix = locale3.currency === void 0 ? "" : locale3.currency[0] + "", currencySuffix = locale3.currency === void 0 ? "" : locale3.currency[1] + "", decimal = locale3.decimal === void 0 ? "." : locale3.decimal + "", numerals = locale3.numerals === void 0 ? identity_default4 : formatNumerals_default(map3.call(locale3.numerals, String)), percent = locale3.percent === void 0 ? "%" : locale3.percent + "", minus = locale3.minus === void 0 ? "\u2212" : locale3.minus + "", nan = locale3.nan === void 0 ? "NaN" : locale3.nan + "";
    function newFormat(specifier) {
      specifier = formatSpecifier(specifier);
      var fill = specifier.fill, align = specifier.align, sign4 = specifier.sign, symbol = specifier.symbol, zero3 = specifier.zero, width = specifier.width, comma = specifier.comma, precision = specifier.precision, trim = specifier.trim, type2 = specifier.type;
      if (type2 === "n")
        comma = true, type2 = "g";
  ...
  var binomial_default = function sourceRandomBinomial(source) {
    ...
    function randomBinomial(n, p) {
      ...
      return function() {
        ...
        var sign4 = pp < 0.5, pFinal = sign4 ? pp : 1 - pp, g = G(pFinal);
        for (var s2 = g(), k2 = 0; s2 <= nn; ++k2)
          s2 += g();
        return acc + (sign4 ? k2 : nn - k2);
      };
    }
  ...
  function log3() {
    ...
    scale2.copy = () => copy(scale2, log3()).base(scale2.base());
    initRange.apply(scale2, arguments);
    return scale2;
  }
  ...
  function pow4() {
    ...
    scale2.copy = function() {
      return copy(scale2, pow4()).exponent(scale2.exponent());
    };
    initRange.apply(scale2, arguments);
    return scale2;
  }
  ...
  function pad2(value, fill, width) {
    var sign4 = value < 0 ? "-" : "", string = (sign4 ? -value : value) + "", length3 = string.length;
    return sign4 + (length3 < width ? new Array(width - length3 + 1).join(fill) + string : string);
  }
  function requote(s2) {
  ...
  function cornerTangents(x06, y06, x12, y12, r1, rc, cw) {
    var x01 = x06 - x12, y01 = y06 - y12, lo = (cw ? rc : -rc) / sqrt5(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x06 + ox, y11 = y06 + oy, x10 = x12 + ox, y10 = y12 + oy, x004 = (x11 + x10) / 2, y004 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r = r1 - rc, D3 = x11 * y10 - x10 * y11, d = (dy < 0 ? -1 : 1) * sqrt5(max4(0, r * r * d2 - D3 * D3)), cx0 = (D3 * dy - dx * d) / d2, cy0 = (-D3 * dx - dy * d) / d2, cx1 = (D3 * dy + dx * d) / d2, cy1 = (-D3 * dx + dy * d) / d2, dx0 = cx0 - x004, dy0 = cy0 - y004, dx1 = cx1 - x004, dy1 = cy1 - y004;
  ...
  function arc_default() {
    ...
    function arc() {
      var buffer, r, r0 = +innerRadius.apply(this, arguments), r1 = +outerRadius.apply(this, arguments), a0 = startAngle.apply(this, arguments) - halfPi5, a1 = endAngle.apply(this, arguments) - halfPi5, da2 = abs5(a1 - a0), cw = a1 > a0;
      if (!context)
        context = buffer = path_default2();
      if (r1 < r0)
        r = r1, r1 = r0, r0 = r;
      if (!(r1 > epsilon9))
        ...
        context.moveTo(r1 * cos4(a0), r1 * sin4(a0));
        context.arc(0, 0, r1, a0, a1, !cw);
        if (r0 > epsilon9) {
          context.moveTo(r0 * cos4(a1), r0 * sin4(a1));
          context.arc(0, 0, r0, a1, a0, cw);
        }
      } else {
        var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon9 && (padRadius ? +padRadius.apply(this, arguments) : sqrt5(r0 * r0 + r1 * r1)), rc = min3(abs5(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t03, t13;
        if (rp > epsilon9) {
          var p02 = asin3(rp / r0 * sin4(ap)), p1 = asin3(rp / r1 * sin4(ap));
        ...
        if (rc > epsilon9) {
          ...
          if (da2 < pi6 && (oc = intersect(x01, y01, x004, y004, x11, y11, x10, y10))) {
            var ax = x01 - oc[0], ay = y01 - oc[1], bx = x11 - oc[0], by = y11 - oc[1], kc = 1 / sin4(acos2((ax * bx + ay * by) / (sqrt5(ax * ax + ay * ay) * sqrt5(bx * bx + by * by))) / 2), lc = sqrt5(oc[0] * oc[0] + oc[1] * oc[1]);
  ...
  var asterisk_default = {
    draw(context, size) {
      const r = sqrt5(size + min3(size / 28, 0.75)) * 0.59436;
      const t = r / 2;
      const u4 = t * sqrt32;
      context.moveTo(0, r);
      context.lineTo(0, -r);
  ...
  var plus_default = {
    draw(context, size) {
      const r = sqrt5(size - min3(size / 7, 2)) * 0.87559;
      context.moveTo(-r, 0);
      context.lineTo(r, 0);
      context.moveTo(0, r);
      context.lineTo(0, -r);
  ...
  var kr = sin4(pi6 / 10) / sin4(7 * pi6 / 10);
  var kx = sin4(tau7 / 10) * kr;
  var ky = -cos4(tau7 / 10) * kr;
  var star_default = {
    draw(context, size) {
      const r = sqrt5(size * ka);
      const x4 = kx * r;
      const y4 = ky * r;
      context.moveTo(0, -r);
  ...
  var x_default3 = {
    draw(context, size) {
      const r = sqrt5(size - min3(size / 6, 1.7)) * 0.6189;
      context.moveTo(-r, -r);
      context.lineTo(r, r);
      context.moveTo(-r, r);
      context.lineTo(r, -r);
  ...
  var d3 = require_src();
  var topojson = require_topojson_node();
  var projection2;
  var Home = {
    init: () => {
      Home.map();
      ...
      $(window).resize(function() {
        const svg2 = d3.select("#worldmap").remove();
        Home.map();
        Home.insertData();
      });
    },
    map: () => {
      ...
      projection2 = guyou_default().translate([width / 2, height / 2]);
      if (window.innerWidth >= 1200) {
        projection2.angle(-90).rotate([18, -90]);
      }
      if (window.innerWidth <= 1200) {
        projection2.rotate([18, -90]);
      }
      if (window.innerWidth <= 800) {
        projection2.angle(-90).rotate([18, -90]).scale(100);
      }
      const svg2 = d3.select("#map").append("svg").attr("id", "worldmap").attr("viewBox", [0, 0, width, height]);
      ...
      d3.json("https://gist.githubusercontent.com/sinanatra/91a7736f19e6636592703a459a8bfe75/raw/ca86b3ea72d66a68945624f3e933445c766aa28f/pixel25.json").then(function(topology) {
        ...
        g.selectAll("path").data(topo.features).enter().append("path").attr("d", path2).attr("class", "map");
      });
    },
    insertData: () => {
      d3.tsv("./windows.tsv").then(function(tsv3) {
        ...
        div.append("a").attr("target", "_blank").attr("href", (d) => `https://drive.google.com/uc?export=view&id=${d["img"].replace("https://drive.google.com/u/0/open?usp=forms_web&id=", "")}`).append("img").attr("src", (d) => `https://drive.google.com/uc?export=view&id=${d["img"].replace("https://drive.google.com/u/0/open?usp=forms_web&id=", "")}`);
        ...
        svg2.selectAll(".mark").data(tsv3).enter().append("circle").attr("class", "mark").attr("r", 3).attr("data-attr", (d) => `${d["img"].replace("https://drive.google.com/u/0/open?usp=forms_web&id=", "")}`).attr("class", (d) => "mark").attr("transform", function(d) {
          return "translate(" + projection2([d.Longitude, d.Latitude]) + ")";
        }).on("mouseover", onMouseover).on("mouseout", onMouseout);
      });
    }
  };
  function onMouseover(elemData) {
    const self2 = d3.select(this), attr = self2.attr("data-attr"), thisClass = self2.attr("class");
    if (thisClass == "mark") {
    ...
    d3.selectAll(`.images-js[data-attr='${attr}']`).classed("color", true);
    d3.select(`circle[data-attr='${attr}']`).attr("r", 12).raise();
  }
  function onMouseout(elemData) {
    d3.select("svg").selectAll("circle").attr("r", 3);
    d3.selectAll(".images-js").classed("color", false);
  }
